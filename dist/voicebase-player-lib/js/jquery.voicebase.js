...
*/
            ...
            $('.vbs-transcript-block').on('touchstart click', '.vbs-order-human-trans a', function(event) {
                var isOrdered = $(event.target).parents('.vbs-order-human-trans').hasClass('vbs-human-ordered');
            ...
            if(VB.settings.toggleBlocks && VB.settings.togglePredictionsBlock){
                ...
                VB.helper.find(".vbs-predictions-block  .vbs-section-title").on('touchstart click', function(e) {
                    e.preventDefault();
                    var $this = $(this);
                    $this.toggleClass('vbs-hidden');
                    if ($this.hasClass('vbs-hidden')) {
...
//                        $thistopic.parent().show();
        ...
        * */
        ...
        setOrderedButton: function (humanOrderDueDate) {
            ...
            $transBtn.find('a').text('Transcript due ' + orderMonth + ' ' + orderDay);
        },
